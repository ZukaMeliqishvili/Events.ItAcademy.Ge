...
using Events.ItAcademy.Ge.Mvc.Models.EventVM;
using Mapster;
...
namespace Events.ItAcademy.Ge.Mvc.Controllers
{
    public class EventController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [HttpPost]
        public async Task<IActionResult> Create(EventRequestVM model, IFormFile file, CancellationToken cancellationToken=default)
        {
            ...
            try
            {
                ...
                var request = model.Adapt<EventRequestModel>();
